...
public class TeacherRegist extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button submit = (Button)findViewById(R.id.teacher_reg_submit);
        submit.setOnClickListener(this);
    }

    public void onClick(View v){
        switch (v.getId()){
            case(R.id.teacher_reg_submit):
                EditText username =(EditText)findViewById(R.id.teacher_reg_username);
                EditText name =(EditText)findViewById(R.id.teacher_reg_name);
                EditText passwd =(EditText)findViewById(R.id.teacher_reg_password);
                EditText passwd2 = (EditText)findViewById(R.id.teacher_reg_password2);
    ...
    public void Next(){
        ...
        if(T.data.equals("True")) {
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    //放在UI线程弹Toast
                    Toast.makeText(TeacherRegist.this, "Regist Successfully", Toast.LENGTH_SHORT).show();
                }
            });
            Intent intent = new Intent(TeacherRegist.this, TeacherLogin.class);
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    //放在UI线程弹Toast
                    Toast.makeText(TeacherRegist.this, "Regist Failed", Toast.LENGTH_LONG).show();
                }
            });
        }
    }
